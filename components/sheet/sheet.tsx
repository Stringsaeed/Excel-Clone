...
const Sheet: React.FC = () => {
  ...
  return (
    <div className="sheet-container animate-fade-in" onKeyDown={handleKeyDown} tabIndex={0}>
      <SheetToolbar />
      <FormulaBar
        value={formulaValue}
      ...
      <div
        ref={parentRef}
        className="relative size-full flex-1 overflow-auto bg-white dark:bg-gray-900"
      >
        {/* Column headers */}
